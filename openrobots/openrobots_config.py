...
PROTOCOL_PARAMETERS_REQUIRED_FOR_STATION_B = ['NUM_SAMPLES', 'REAGENT_LABWARE','MAGPLATE_LABWARE', 'WASTE_LABWARE', 'ELUTION_LABWARE','DISPENSE_BEADS']
...
MAP_PROTOCOL_PARAMETER_TO_DATABASE_STATION_B = [('NUM_SAMPLES','numberOfSamples') ,('REAGENT_LABWARE','reagentLabware'),('MAGPLATE_LABWARE', 'magPlateLabware'),
        ('WASTE_LABWARE', 'wasteLabware'),  ('ELUTION_LABWARE','elutionLabware'),('DISPENSE_BEADS', 'dispenseBeads')]
